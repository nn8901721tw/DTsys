    ...
    <section className="flex flex-col md:flex-row h-screen items-center">
      <div className="hidden bg-[#8AB3B6] w-full md:w-1/2 xl:w-1/2 h-screen md:flex md:items-center md:justify-center">
        <div className='flex flex-col -m-56'>
          <h1 className=' md:mx-auto md:text-4xl xl:text-6xl mx-auto text-gray-200  mb-2'>NCU Design Thinking</h1>
          {/* <TypeAnimation
        ...
        <div className="w-full h-100">
          ...
          <form className="mt-6">
            <div>
              ...
              <input type="text" name="username" placeholder="Email" onChange={handleChange} className="text-base w-full px-4 py-3 bg-transparent border-b border-gray-500 focus:outline-none" autoFocus required />
            </div>
            <div className="mt-4">
              <label className="block text-gray-700 text-base"></label>
              <input type="password" name="password" placeholder="Password" minLength="6" onChange={handleChange} className="text-base w-full px-4 py-3 bg-transparent border-b border-gray-500 focus:outline-none" required />
              {error && <span className='text-xs text-red-600'>{error}</span>}
            </div>
            <button type="submit" onClick={handleSubmit} className="w-full block bg-[#8AB3B6] hover:bg-[#578082] focus:bg-[#8AB3B6] text-white font-semibold rounded-lg px-4 py-3 mt-6 text-base">login</button>
          </form>
