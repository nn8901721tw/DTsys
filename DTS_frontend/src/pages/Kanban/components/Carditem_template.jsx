...
export default function Carditemtemplate({ data, index}) {
  ...
  return (
    <>
    <Draggable  index={index} draggableId={`item-${index}`}>
      {(provided, snapshot) => (
        <div 
        ...
        >
          <div>
          <span className='text-md my-3 text-base leading-6'>{cardData.scaffolding_template}</span>
