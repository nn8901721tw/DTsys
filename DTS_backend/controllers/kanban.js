...
exports.initializeData =async()=>{
    try {
        await Kanban_scaffolding.bulkCreate([
            ...
            { id:'6',sub_stage: '1-4', scaffolding_template: '蒐集資料並彙整（實際場域訪談、網路）' },
            { id:'7',sub_stage: '1-4', scaffolding_template: '歸納利害關係人遇到的問題（找出問題的根本）' },
            // { id:'9',sub_stage: '2-1', scaffolding_template: '考量成本、時間' },
            // { id:'9',sub_stage: '2-1', scaffolding_template: '定義出真正值得解決的問題' },
            { id:'8',sub_stage: '2-1', scaffolding_template: '討論與反思' },  //團隊成員間就初步問題進行討論，確認問題的有效性和相關性。
            { id:'9',sub_stage: '2-2', scaffolding_template: '定義出真正值得解決的問題' },
            // { id:'10',sub_stage: '2-2', scaffolding_template: '使用公平的投票方式' },
            { id:'10',sub_stage: '3-1', scaffolding_template: '解決方案的發想' },
            // { id:'12',sub_stage: '3-1', scaffolding_template: '考量成本、時間' },
            { id:'11',sub_stage: '3-2', scaffolding_template: '組內整合解決方法' },
            { id:'12',sub_stage: '4-1', scaffolding_template: '開始實作原型(Figma、Draw.io)' },
            { id:'13',sub_stage: '5-1', scaffolding_template: '將原型進行實際場域測試' },
            { id:'14',sub_stage: '5-1', scaffolding_template: '蒐集並分析場域測試結果' },
            { id:'15',sub_stage: '5-2', scaffolding_template: '整理出修正要點' },          
            { id:'16',sub_stage: '5-2', scaffolding_template: '開始修正原型' }
            // 添加更多資料...
